...
export default function CartError({
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center gap-4 px-4 text-center">
      ...
      <div>
        <p className="font-heading font-bold text-[18px] text-ink">Couldn&apos;t load your cart</p>
        <p className="mt-1 text-[13px] text-slate">Something went wrong while loading your cart.</p>
      </div>
      {error.digest && (
