          ...
          >
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              ...
              >
                <Link
                  href="/showroom"
                  className="inline-flex items-center gap-2 rounded-[10px] bg-gold px-6 py-3 font-heading font-bold text-[13.5px] text-forest transition-all hover:bg-gold/88"
                >
