/**
 * Seeds the remaining 19 new products from D:\Furniture\Generated: 8
 * dressing tables/consoles, 7 nightstands, 2 coffee tables, 1 storage
 * bench, 1 wardrobe. Run:
...
async function seed() {
  ...
  const products: SeedProduct[] = [
    // ── Dressing tables / consoles ──────────────────────────────────────
    {
      ...
      finishName: "Dark Grey",
      images: ["X-Door Console/x-door-console-dark-grey-console-table-1.png", "X-Door Console/x-door-console-dark-grey-console-table-2.png"],
    },
    {
      ...
      finishName: "Brown",
      images: ["Rattan Arch Console/rattan-arch-console-brown-console-table-1.png", "Rattan Arch Console/rattan-arch-console-brown-console-table-2.png"],
    },
    {
      ...
      finishName: "Brown",
      images: ["Ring-Pull Dresser/ring-pull-dresser-brown-dresser-1.png", "Ring-Pull Dresser/ring-pull-dresser-brown-dresser-2.png"],
    },
    {
      ...
      finishName: "White",
      images: ["Cloud Mirror Vanity/cloud-mirror-vanity-white-dressing-table-mirror-1.png", "Cloud Mirror Vanity/cloud-mirror-vanity-white-dressing-table-mirror-2.png"],
    },
    {
      ...
      finishName: "Rust",
      images: [1, 2, 3, 4, 5, 6, 7, 8].map((i) => `Backlit Round Vanity/backlit-round-vanity-rust-vanity-set-${i}.png`),
    },
    {
      ...
      finishName: "Offwhite",
      images: [1, 2, 3, 4].map((i) => `Oval Vanity/oval-vanity-offwhite-vanity-set-${i}.png`),
    },
    {
      ...
      finishName: "Gray",
      images: ["Velvet Arch Vanity/velvet-arch-vanity-gray-vanity-set-1.png", "Velvet Arch Vanity/velvet-arch-vanity-gray-vanity-set-2.png"],
    },
    {
      ...
      finishName: "Purple",
      images: [1, 2, 3, 4, 5, 6].map((i) => `Arch Cabinet Vanity/arch-cabinet-vanity-purple-vanity-set-${i}.png`),
    },
    ...
    // ── Nightstands ──────────────────────────────────────────────────────
    {
      ...
      finishName: "Dark Grey",
      images: [1, 2, 3].map((i) => `Arched Fluted Nightstand/arched-fluted-nightstand-dark-grey-nightstand-${i}.png`),
    ...
    },
    {
      ...
      finishName: "Olive Green",
      images: ["Reeded Nightstand/reeded-nightstand-olive-green-nightstand-1.png", "Reeded Nightstand/reeded-nightstand-olive-green-nightstand-2.png"],
      variants: NIGHTSTAND_VARIANTS,
    },
    {
      ...
      finishName: "Beige",
      images: [1, 2].map((i) => `Marble-Top Ribbed Nightstand (Paired)/marble-top-ribbed-nightstand-paired-beige-nightstand-pair-${i}.png`),
    },
    {
      ...
      finishName: "Beige",
      images: [1, 2].map((i) => `Marble-Top Ribbed Nightstand (Round)/marble-top-ribbed-nightstand-round-beige-nightstand-${i}.png`),
    },
    {
      ...
      finishName: "Gray",
      images: ["Glow Shelf Nightstand/glow-shelf-nightstand-gray-nightstand-1.png", "Glow Shelf Nightstand/glow-shelf-nightstand-gray-nightstand-2.png"],
      variants: NIGHTSTAND_VARIANTS,
    },
    {
      ...
      finishName: "Brown",
      images: ["Ring-Pull Nightstand/ring-pull-nightstand-brown-nightstand-1.png", "Ring-Pull Nightstand/ring-pull-nightstand-brown-nightstand-2.png"],
      variants: NIGHTSTAND_VARIANTS,
    },
    {
      ...
      finishName: "White",
      images: ["Two-Tone Panel Nightstand/two-tone-panel-nightstand-white-nightstand-1.png"],
      variants: NIGHTSTAND_VARIANTS,
    },
    ...
    // ── Coffee tables & storage ──────────────────────────────────────────
    {
      ...
      finishName: "Dark Grey",
      images: ["Double-Shelf Nesting Coffee Table/double-shelf-nesting-coffee-table-dark-grey-coffee-table-1.png"],
    },
    {
      ...
      finishName: "Dark Grey",
      images: ["Nesting Ottoman Coffee Table/nesting-ottoman-coffee-table-dark-grey-coffee-table-1.png", "Nesting Ottoman Coffee Table/nesting-ottoman-coffee-table-dark-grey-coffee-table-2.png"],
    },
    {
      ...
      care: CARE_VELVET,
      description: "Channel-tufted storage bench in ice-blue velvet with slim tapered legs. A soft-close storage seat for the end of a bed or living room.",
      tags: ["storage bench", "tufted bench", "bedroom bench", "upholstered bench", "storage ottoman"],
      finishName: "Light Blue",
      images: ["Channel Storage Bench/channel-storage-bench-light-blue-storage-bench-1.png", "Channel Storage Bench/channel-storage-bench-light-blue-storage-bench-2.png"],
    },
    ...
    // ── Wardrobe ─────────────────────────────────────────────────────────
    {
      ...
      finishName: "Gray",
      images: [1, 2, 3, 4].map((i) => `Glass Niche Wardrobe/glass-niche-wardrobe-gray-wardrobe-${i}.png`),
    },
  ]
  ...
  for (const p of products) {
    ...
    const images = await finishImagesField(p.images)
    const finishes = [{ _key: "f1", name: p.finishName, priceModifier: 0, images }]
